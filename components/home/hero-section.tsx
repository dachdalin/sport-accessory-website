      ...
      <div className="container mx-auto px-4 relative z-10 py-20">
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            <span className="text-white/50 text-sm font-medium">Ends in:</span>
          ...
          <p className="mt-5 text-base md:text-lg text-white/60 max-w-xl leading-relaxed">
            Cambodia&apos;s #1 sport accessories store. Premium quality gear delivered fast to Phnom Penh, Siem Reap & nationwide.
          </p>
          ...
          <div className="mt-8 flex items-center gap-3 flex-wrap">
            <span className="text-white/30 text-xs">Accepted:</span>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white/5 backdrop-blur border-t border-white/10 py-2 overflow-hidden">
        <div className="flex items-center gap-8 animate-[ticker_20s_linear_infinite]" style={{ width: "max-content" }}>
          {Array.from({ length: 4 }).flatMap(() => [
            "🔥 Sok Dara from Phnom Penh bought Running Shoes",
            "⚡ Vanna from Siem Reap bought Gym Gloves",
            "🏆 Chanthou from Battambang bought Football Kit",
            "✅ Free shipping on orders over $30",
            "💳 QR Pay accepted — ABA & Wing",
          ]).map((item, i) => (
