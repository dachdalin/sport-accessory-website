        ...
        <main className="flex-1">
          ...
          <section className="px-4 py-14 md:py-20">
            <div className="mx-auto max-w-3xl space-y-10">
              ...
              <div>
                <h2
                  className="text-base font-semibold uppercase tracking-widest text-white/35 mb-5"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  Get in Touch
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {CHANNELS.map((ch) => (
                    <a
                      ...
                      className="group flex items-start gap-4 rounded-2xl border border-white/8 bg-[#0D1525]/70 p-5 hover:border-orange-500/30 transition-all duration-200 hover:bg-[#0D1525]"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          <p className="text-xs font-semibold uppercase tracking-wider text-white/40">{ch.label}</p>
                          {ch.badge && (
                        ...
                        <p className="text-xs text-white/45 mt-1 leading-5">{ch.note}</p>
                      </div>
                      <ExternalLink className="h-4 w-4 text-white/20 group-hover:text-white/50 flex-shrink-0 mt-1 transition-colors" />
                    </a>
                  ))}
                </div>
              </div>
              ...
              {/* Business Hours */}
              <div className="rounded-2xl border border-white/8 bg-[#0D1525]/70 p-6">
                ...
                <p className="mt-4 text-xs text-white/35 leading-5">
              ...
              {/* Location + Map */}
              <div className="rounded-2xl border border-white/8 bg-[#0D1525]/70 overflow-hidden">
                {/* Address header */}
                <div className="flex items-start gap-4 p-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/60 mt-1">SportGear Pro KH Showroom</p>
                    <p className="text-sm text-white/60">Street 271, Sangkat Toul Tumpung Ti Muoy</p>
                    <p className="text-sm text-white/60">Khan Chamkarmon, Phnom Penh, Cambodia</p>
                    <a
                ...
                {/* Map embed */}
                <div className="relative h-72 md:h-96 w-full border-t border-white/8">
                  <iframe
